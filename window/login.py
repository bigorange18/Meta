...
class LoginUi(object):
    def setupUi(self, Dialog):
        ...
        self.widget.setGeometry(QRect(50, 110, 671, 234))
        ...
        self.login_name = QLineEdit(self.widget)
        ...
        self.login_password = QLineEdit(self.widget)
        ...
        self.login_fail = QPushButton(self.widget)
